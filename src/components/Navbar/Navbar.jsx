  ...
  return (
    <div className="nav-bar">
      ...
      <div className="nav-links">
        <Link to="/" className="link">Проблемы</Link>
        <Link to="/" className="link">Изучить</Link>
        <Link to="/" className="link">Конкурс</Link>
        <Link to="/" className="link">Обсуждение</Link>
      </div>
      <div className="nav-icons">
        ...
        <div className="icon-wrapper" onClick={handleUserClick}>
          <img src={usericon} alt="Пользователь" id="userIcon" className="icon" />
        </div>
      </div>
    </div>
  );
